...
- (DKFontPicker)dk_textFontPicker {
    return objc_getAssociatedObject(self, @selector(dk_textFontPicker));
}

- (void)dk_setTextFontPicker:(DKFontPicker)picker {
    objc_setAssociatedObject(self, @selector(dk_textFontPicker), picker, OBJC_ASSOCIATION_COPY_NONATOMIC);
